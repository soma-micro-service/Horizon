...
from openstack_dashboard.dashboards.project.appcluster.views import \
    TranslationHelper
from openstack_dashboard.test import helpers as test
from openstack_dashboard.usage import quotas

JSON_URL = reverse('horizon:project:appcluster:json')
INDEX_URL = reverse('horizon:project:appcluster:index')
...
class NetworkTopologyCreateTests(test.TestCase):
    ...
    def _test_new_button_disabled_when_quota_exceeded(
        ...
        self.assertTemplateUsed(res, 'project/appcluster/index.html')
    ...
    def test_create_network_button_disabled_when_quota_exceeded(self):
        url = reverse('horizon:project:appcluster:createnetwork')
    ...
    def test_create_router_button_disabled_when_quota_exceeded(self):
        url = reverse('horizon:project:appcluster:createrouter')
        classes = 'btn btn-default ajax-modal'
    ...
    def test_launch_instance_button_disabled_when_quota_exceeded(self):
        url = reverse('horizon:project:appcluster:launchinstance')
